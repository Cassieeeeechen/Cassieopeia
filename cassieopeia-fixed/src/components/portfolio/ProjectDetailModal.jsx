  ...
  return (
    <div className="relative rounded-2xl overflow-hidden bg-black aspect-video group cursor-pointer">
      ...
      <div className="absolute bottom-6 left-8">
        <p className="text-white/50 text-[11px] tracking-[0.3em] uppercase font-medium">Process Film</p>
        ...
        className="fixed inset-0 z-[100] bg-white overflow-y-auto">
          ...
          <div className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 h-16 bg-white/80 backdrop-blur-xl border-b border-gray-100">
            <p className="text-[11px] font-light tracking-[0.15em] text-gray-400">
              ...
              <span className="mx-1 opacity-40">›</span> {project.category.toLowerCase().replace(/\s+/g, '-')}-{project.year}
            </p>
            <button
            onClick={onClose}
          ...
          <div className="max-w-5xl mx-auto px-6 md:px-12 py-20">
            ...
            { label: 'Scope', value: project.id === 0 ? 'Commercial Photography' : project.id === 1 ? 'Full Brand Identity' : project.id === 5 ? 'Children\'s Picture Book Design' : project.id === 6 ? 'Digital Card System' : (project.id === 2 || project.id === 12 || project.id === 13) ? 'Outdoor Billboard Campaign' : project.id === 25 ? 'Brand Identity · Print' : 'Full Identity' },
            { label: 'Deliverables', value: project.id === 0 ? 'Visual Design · AI Enhanced' : project.id === 1 ? 'Photography · Print · Digital · UI · Outdoor' : project.id === 5 ? 'Illustration · Book Layout · Bilingual Design · Print Production' : project.id === 6 ? 'Card Design · Digital Wallet Assets · Multiple Formats' : (project.id === 2 || project.id === 12 || project.id === 13) ? 'Billboard Design · Multiple Formats · Motion Concept' : project.id === 25 ? 'Logo Design · Business Card · Brand Guidelines' : 'Brand System' }].
            map((m) =>
            <div key={m.label}>
            ...
            className="py-16">
              ...
              <p className="text-[11px] font-medium tracking-[0.4em] uppercase text-purple-400 mb-6">Overview</p>
            ...
            className="mb-24">
              ...
              <p className="text-[11px] font-medium tracking-[0.4em] uppercase text-purple-400 mb-6">Process Film</p>
            ...
            className="mt-32">
              ...
              <p className="text-[11px] font-medium tracking-[0.4em] uppercase text-purple-400 mb-8">Gallery</p>
            ...
            className="mt-16 pt-16 border-t border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              ...
              <div>
                <p className="text-[11px] font-medium tracking-[0.4em] uppercase text-gray-400 mb-2">Next Step</p>
                <p className="text-2xl font-extralight text-gray-800 tracking-tight">Have a similar project in mind?</p>
              </div>
              <a
              href="#contact"
              onClick={onClose}
